...
export const TABLES = {
  ...
  leads: {
    ...
    toRow: (l, i) => ({
      ...
      stage: l.stage, broker: l.broker ?? null, broker_contact: l.brokerContact ?? null,
      tenant_kind: l.tenantKind ?? 'new', deal_type: l.dealType ?? null,
      activity: l.activity ?? null, timing: l.timing ?? null,
      intro_date: l.intro ?? null, visits: l.visits ?? [],
      events: l.events ?? [], comment_log: l.commentLog ?? [],
      last_proposal: l.lastProposal ?? null, proposal_agreed: l.proposalAgreed ?? null,
    ...
    fromRow: (r) => ({
      ...
      stage: r.stage, broker: r.broker, brokerContact: r.broker_contact,
      tenantKind: r.tenant_kind ?? 'new', dealType: r.deal_type,
      activity: r.activity, timing: r.timing,
      intro: r.intro_date, visits: r.visits ?? [],
      events: r.events ?? [], commentLog: r.comment_log ?? [],
      lastProposal: r.last_proposal, proposalAgreed: r.proposal_agreed,
      comments: r.comments,
